...
<head>
		<title>Torne-se um voluntário</title>
		<meta charset="utf-8" />
...
$query = "INSERT INTO cadastro_voluntarios (Nome, Telefone) VALUES ( '$Nome', '$Telefone')";

// Execute the query
if ($mysqli->query($query)) {
    echo 'Agora você é um de nós. Aguarde mais informações!';
} else {
